...
const nearbyMarkers = [
  {
    ...
    lng: 0.03,
    type: "landslide",
    label: "Past landslide zone",
  },
  {
    lat: -0.015,
    lng: 0.02,
    type: "deformation",
    label: "Deformation detected",
  },
  {
    lat: 0.01,
    lng: -0.025,
    type: "landslide",
    label: "Historical event site",
  },
  {
    lat: -0.03,
    lng: -0.01,
    type: "deformation",
    label: "Ground movement zone",
  },
  {
    lat: 0.025,
    lng: 0.015,
    type: "landslide",
    label: "Susceptible slope",
  },
  {
    lat: -0.02,
    lng: 0.035,
    ...
    <div className="w-full h-full rounded-lg overflow-hidden border border-white/5 relative">
      ...
      >
        ...
        {nearbyMarkers.map((marker, index) => {
          const markerColor =
            marker.type === "landslide" ? "#f97316" : "#3b82f6";
          ...
          return (
            <Marker
              ...
              icon={createSmallIcon(markerColor)}
            >
              <Popup>
                <div className="text-xs text-gray-900">
                  ...
                  <div className="text-gray-500 mt-0.5">
                    {marker.type === "landslide"
                      ...
                      : "Satellite-detected deformation"}
                  </div>
                </div>
              </Popup>
            </Marker>
